...
def pdf_router(app):
    ...
    def generate_pdf(id):
        ...
        pdfmetrics.registerFont(TTFont('CustomFont',r'D:\Internal_task\Github_uploaded_project\bug_tracker_internal_project\Backend\pdf_report_generatot\dont.ttf'))  # Use your actual font path
