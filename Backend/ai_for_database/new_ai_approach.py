...
toolkit = SQLDatabaseToolkit(db=db, llm=ChatGroq(temperature=0, groq_api_key="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", model_name="llama-3.3-70b-versatile"))
...
query_check = query_check_prompt | ChatGroq(temperature=0, groq_api_key="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", model_name="llama-3.3-70b-versatile").bind_tools(
...
model_get_schema = ChatGroq(temperature=0, groq_api_key="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", model_name="llama-3.3-70b-versatile").bind_tools(
    [get_schema_tool]
)
workflow.add_node(
    "model_get_schema",
...
query_gen = query_gen_prompt | ChatGroq(temperature=0, groq_api_key="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", model_name="llama-3.3-70b-versatile").bind_tools(
    [SubmitFinalAnswer]
)
