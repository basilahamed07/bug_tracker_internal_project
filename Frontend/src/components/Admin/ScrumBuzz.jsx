    ...
    <div style={{ width: '45%' }}>
      ...
      <Modal show={showScrumModal} onHide={() => setShowScrumModal(false)}>
          ...
          <Form>
            <Form.Group className="mb-3">
              ...
              >
                ...
                {scrums.length === 0 ? (
                  <option disabled>No Scrum available for this project</option>
                ) : (
                  scrums.map((scrum) => (
                ...
                {/* Add option to add a new scrum if no scrums are available */}
                {scrums.length === 0 && (
                  <option value="add_new_scrum">
                    Add New Scrum
                  </option>
                )}
              </Form.Control>
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={handleScrumSelection}>
...
//     // Store PI name in session storage
//     sessionStorage.setItem('piName', newPIName.trim());
//     setShowPIModal(false);
//     navigate('/AdminPanel/CreateSprint');
//   };
...
//       <Modal show={showPIModal} onHide={() => setShowPIModal(false)}>
//         <Modal.Header closeButton>
//           <Modal.Title>Enter Program Increment (PI) Name</Modal.Title>
//         </Modal.Header>
//         <Modal.Body>
//           <Form>
//             <Form.Group className="mb-3">
